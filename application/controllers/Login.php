	...
	function validate_login() {
		...
		if($this->CAPTCHA_STATUS){
			...
			if(isset($post_data['g-recaptcha-response']) && !empty($post_data['g-recaptcha-response'])){
				...
				$secret = '6LdOgjUUAAAAADeZaeCcIvEEULJ6qtG-UI6iMXWX';

				$verifyResponse = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret='.$secret.'&response='.$post_data['g-recaptcha-response']);
