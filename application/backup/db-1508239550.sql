...
INSERT INTO `mlm_activity` (`id`, `mlm_user_id`, `activity`, `ip_address`, `date`, `data`) VALUES
	...
	(99,1900,'db_backup_created','127.0.0.1','2017-10-17 16:27:30','a:0:{}');
...
INSERT INTO `mlm_cron_job` (`id`, `cron_job`, `ip`, `data`, `date`, `status`, `preferences`, `file_status`, `done_by`) VALUES
	(1,'db_backup','127.0.0.1','db-1508237850.sql','2017-10-17 16:27:30','Success',NULL,'active','Admin'),
	(2,'db_backup','127.0.0.1','db-1508237967.sql','2017-10-17 16:29:27','Success',NULL,'active','Cron Job'),
	(3,'db_backup','127.0.0.1','NA','2017-10-17 16:55:50','Started',NULL,'active','Admin');
